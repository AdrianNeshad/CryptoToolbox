...
| BIP39 Tool | Complete BIP39 tool (mnemonic ↔ seed, derivation paths, addresses) |
...
| Exodus seed.seco Unlock | Brute-force Exodus `seed.seco` files (dictionary attack) |
